...
<html lang="en">
    ...
    <body>
        <div id="content">
                ...
                <nav class="navbar navbar-expand-lg">
                    <div class="container">
                        <a class="navbar-brand" href="index.php">
                            <img src="./assets/images/logo-svg-white.svg" alt="Twomads Media" class="w-100 top-logo">
                        </a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarResponsive">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="index" aria-label="About">About</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index" aria-label="Services">Services</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index" aria-label="Our Team">Our team</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="index" aria-label="Contact Us">Contact Us</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <!-- Banner Ends Here -->
            <div class="services has-bg" id="services">
                <div class="container">
                    <div class="row" id="tabs">
                        <!-- HIDDEN FOR LARGE DEVICES -->
                        <?php require_once('./services-mobile.php'); ?>
                        <!-- HIDDEN FOR LARGE DEVICES END -->
                        <div class="col-lg-4 d-none d-lg-block">
                            <ul>
                                <li><a href='#social-media-management' class="social-media-management">Social Media Management<i class="fa fa-angle-right"></i></a></li>
                                ...
                                <li><a href='#digital-and-commercial-advertisement-creation'>Digital Advertisement Creation<i class="fa fa-angle-right"></i></a></li>
